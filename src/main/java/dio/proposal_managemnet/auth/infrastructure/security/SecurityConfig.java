package dio.proposal_managemnet.auth.infrastructure.security;
...
import dio.proposal_managemnet.auth.infrastructure.persistence.entity.repository.UserRepository;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http,
                                            restUsernamePasswordAuthenticarionFilter restUsernamePasswordAuthenticarionFilter) throws Exception {
        http
                ...
                .addFilterAt(restUsernamePasswordAuthenticarionFilter, UsernamePasswordAuthenticationFilter.class)
                ;
